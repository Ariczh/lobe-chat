export default {
  ...
  'localSystem.off.desc': 'Disable local system access.',
  'localSystem.off.title': 'Off',
  'localSystem.on.desc': 'Allow access to local files and commands.',
  'localSystem.on.title': 'Enabled',
  'localSystem.title': 'Local System',
