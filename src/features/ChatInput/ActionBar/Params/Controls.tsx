...
const Controls = memo<ControlsProps>(({ setUpdating }) => {
  ...
  const handleToggle = useCallback(
    async (key: ParamKey, enabled: boolean) => {
      ...
      if (newValue === undefined) {
        // Explicitly delete the property rather than setting it to undefined
        // This ensures Form state synchronization
        delete currentParams[key];
        // Use null as a disabled marker (the database retains null, and the frontend uses it to determine checkbox state)
  ...
  // Use useMemo to ensure the debounced function is only created once
